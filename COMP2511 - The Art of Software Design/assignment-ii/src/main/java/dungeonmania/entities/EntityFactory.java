...
public class EntityFactory {
    ...
    public EntityFactory(JSONObject config, GameMap map) {
        this.config = config;
        this.map = map;
    }
    ...
    public void spawnSpider(Game game, Position player, GameMap map) {
    ...
    public void spawnZombie(Game game, ZombieToastSpawner spawner, GameMap map) {
        int tick = game.getTick();
    ...
    public Player buildPlayer(Position pos) {
        ...
        return new Player(pos, playerHealth, playerAttack, map);
    }
    ...
    public Mercenary buildMercenary(Position pos) {
        ...
        int mindControlDuration = config.optInt("mind_control_duration", Mercenary.DEFAULT_MIND_CONTROL_DURATION);
        return new Mercenary(pos, mercenaryHealth, mercenaryAttack,
                             mercenaryBribeAmount, mercenaryBribeRadius, mindControlDuration);
    }
    ...
    public Assassin buildAssassin(Position pos) {
        ...
        double assassinBribeFail = config.optDouble("assassin_bribe_fail_rate", Assassin.DEFAULT_BRIBE_FAIL);
        int mindControlDuration = config.optInt("mind_control_duration", Assassin.DEFAULT_MIND_CONTROL_DURATION);
        return new Assassin(pos, assassinHealth, assassinAttack, assassinBribeAmount,
                            assassinBribeRadius, assassinBribeFail, mindControlDuration);
    }
    ...
    public MidnightArmour buildMidnightArmour() {
        int extraAttackDamage = config.optInt("midnight_armour_attack");
        int protection = config.optInt("midnight_armour_defence");
        return new MidnightArmour(extraAttackDamage, protection);
    }
